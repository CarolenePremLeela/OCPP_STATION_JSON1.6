...
void MainWindow::writeRequestVoltage(int slave_id)
{
...
//    qDebug()<<"going to request meter no ...:"<<slave_id;
...
void MainWindow::writeRequestFreq(int slave_id)
{
...
int MainWindow::readResponseVoltage(int time, float *unit, int id)
{
     QByteArray data;
              ...
              temp1 = mytypes->i[3];
               ...
               while (temp1 != 0)
                ...
                len2 = 4;
                    ...
                    float ans=hex2*0.01;
                    qDebug()<<ans << "V";
                    ui->lcdNumber_voltage->display(ans);
        }
...
int MainWindow::readResponseFreq(int time, float *unit, int id)
{
     QByteArray data;
...
unsigned int  MainWindow::CRC16 (const  char *nData, int wLength)
{
...
void MainWindow::start()
{
    ...
    Gcom="COM4";
    Gid=1;
    qDebug()<<"Genset COM..:"<<qPrintable(Gcom)<<"GenSet ID ..:"<<Gid;

    serial.close();
    qDebug()<<"port changed to..:"<<qPrintable(Gcom);
